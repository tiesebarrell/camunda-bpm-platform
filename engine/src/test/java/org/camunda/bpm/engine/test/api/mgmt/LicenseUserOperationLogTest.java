...
public class LicenseUserOperationLogTest {
  ...
  public void shouldUpdateOperationLogWhenSetLicense() {
    ...
    // then
    assertOperationLogEntry(entry, UserOperationLogEntry.OPERATION_TYPE_CREATE);
  }
  ...
  public void shouldUpdateOperationLogWhenUpdateLicense() {
    ...
    // then
    assertOperationLogEntry(entry, UserOperationLogEntry.OPERATION_TYPE_UPDATE);
  }
  ...
  public void shouldUpdateOperationLogWhenDeleteLicense() {
    ...
    // then
    assertOperationLogEntry(entry, UserOperationLogEntry.OPERATION_TYPE_DELETE);
  }
  ...
  private void assertOperationLogEntry(UserOperationLogEntry entry, String operationType) {
    ...
    assertThat(entry.getNewValue()).isEqualTo(LicenseCmd.LICENSE_KEY_BYTE_ARRAY_ID);
  }
}
